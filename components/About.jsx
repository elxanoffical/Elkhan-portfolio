...
export default function About() {
  return (
    <Section>
      <FadeUp>
        <h2 className="text-3xl sm:text-4xl font-semibold mb-2 text-[#1F2933]">About Me</h2>
        ...
        <p className="max-w-3xl text-md sm:text-lg leading-relaxed text-[#1F2933]/80">
        ...
        <p className="mt-6 max-w-3xl text-md sm:text-lg leading-relaxed text-[#1F2933]/80">
